<?php
	use yii\helpers\Html;
 	use yii\helpers\Url;
	$this->title = Yii::t('app', 'Grow Seller');
 	...
 	echo Html::beginForm( Url::to(['admin-summary/summary-order']), 'get');
?>
	<div class="row">
			...
			<div class="col-lg-12">
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<th><?php echo Yii::t('app', 'Total Sale') ?></th>
							<?php foreach($sumInMonth as $key => $value):?>
